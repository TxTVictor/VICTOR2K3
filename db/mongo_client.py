...
class MongoDB(object):
    def __init__(self):
        self.client = pymongo.MongoClient("mongodb://mongo:wTadWKOFnVEgzColSHClXDpMvmblWlmp@monorail.proxy.rlwy.net:39698")
...
def expulse_user():
    client = pymongo.MongoClient("mongodb://mongo:wTadWKOFnVEgzColSHClXDpMvmblWlmp@monorail.proxy.rlwy.net:39698")
    db = client["bot"]
    collection = db["user"]
